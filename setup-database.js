...
async function setupDatabase() {
    ...
    try {
        ...
        // Insert sample users
        const insertUsers = `
            INSERT IGNORE INTO users (name, email, password_hash, phone, user_type, email_verified) VALUES
            ('System Admin', 'admin@rwandaeats.com', '${adminPassword}', '+250788000001', 'system_admin', TRUE),
            ('Hotel des Mille Collines', 'admin@millecollines.rw', '${restaurantPassword}', '+250788000002', 'restaurant_admin', TRUE),
            ('Heaven Restaurant', 'admin@heaven.rw', '${restaurantPassword}', '+250788000003', 'restaurant_admin', TRUE),
            ('The Hut', 'admin@thehut.rw', '${restaurantPassword}', '+250788000004', 'restaurant_admin', TRUE),
            ('John Doe', 'john@example.com', '${customerPassword}', '+250788000005', 'customer', TRUE),
            ('Jane Smith', 'jane@example.com', '${customerPassword}', '+250788000006', 'customer', TRUE);
        `;
        ...
        const insertRestaurants = `
            INSERT IGNORE INTO restaurants (name, description, location, contact_phone, contact_email, opening_time, closing_time, cuisine_type, price_range, tables_count, restaurant_admin_id, is_active) VALUES
        ...
        await connection.query(insertRestaurants);
        console.log('Sample restaurants created');

        // Insert sample menu items
        const insertMenuItems = `
            INSERT IGNORE INTO menu_items (restaurant_id, name, description, price, category, is_available) VALUES
        ...
        const insertEmailTemplates = `
            INSERT IGNORE INTO email_templates (name, subject, body, is_active) VALUES
        ...
        await connection.query(insertEmailTemplates);
        console.log('Email templates created');

        // Insert SMS templates
        const insertSmsTemplates = `
            INSERT IGNORE INTO sms_templates (name, message, is_active) VALUES
        ...
        await connection.query(insertSmsTemplates);
